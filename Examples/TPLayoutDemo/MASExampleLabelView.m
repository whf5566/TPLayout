...
//    }];
    self.longLabel.al_left.equal(self.al_left).insets(kPadding);
...
//    }];
    ...
    self.shortLabel.al_top.equal(self.longLabel.al_baseline);
    self.shortLabel.al_right.equal(self.al_right).insets(kPadding);
