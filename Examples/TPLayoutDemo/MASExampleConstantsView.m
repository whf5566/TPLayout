...
//    }];
    ...
    purpleView.al_top.equal(@20);
    purpleView.al_left.equal(@20);
    purpleView.al_bottom.equal(@-20);
    purpleView.al_right.equal(@-20);
...
//    }];
    {
      // same
//    orangeView.al_centerX.equal(@0);
//    orangeView.al_centerY.equal(@50);
//    orangeView.al_width.equal(@200);
//    orangeView.al_height.equal(@100);
    }
    
    orangeView.al_center.equal(CGPointMake(0, 50));
    orangeView.al_size.equal(CGSizeMake(200, 100));
