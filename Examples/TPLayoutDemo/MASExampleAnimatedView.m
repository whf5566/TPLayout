...
//    }];
    ...
    [self.animatableConstraints addObjectsFromArray:
        greenView.al_edges.priorityLow().equal(superview).insets(paddingInsets)];
    [self.animatableConstraints addObject:
        greenView.al_bottom.equal(blueView.al_top).offset(-padding)];
    greenView.al_size.equal(redView);
...
//    }];
    [self.animatableConstraints addObjectsFromArray:
        redView.al_edges.priorityLow().equal(superview).insets(paddingInsets)];
    [self.animatableConstraints addObjectsFromArray:@[
...
//    }];
    ...
    [self.animatableConstraints addObjectsFromArray:
        blueView.al_edges.priorityLow().equal(superview).insets(paddingInsets)];
...
//    }
    ...
    self.animatableConstraints.insets(paddingInsets);
