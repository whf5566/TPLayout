...
//    }];
    ...
    self.movingButton.al_resetAll();
    self.movingButton.al_width.equal(@100);
    self.movingButton.al_height.equal(@100);
    if (self.topLeft) {
        self.movingButton.al_left.equal(self.al_left).offset(10);
        self.movingButton.al_top.equal(self.al_top).offset(10);
    } else {
        self.movingButton.al_bottom.equal(self.al_bottom).offset(-10);
        self.movingButton.al_right.equal(self.al_right).offset(-10);
    }
